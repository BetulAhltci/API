 ...
 */
        ...
        System.out.println("Sokak adı :"+kisiBilgisi.getJSONObject("address").get("streetAddress"));
        ...
        System.out.println("Tel no :"+kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(0).get("number"));
        System.out.println("Tel türü  :"+kisiBilgisi.getJSONArray("phoneNumbers").getJSONObject(1).get("type"));
